...
const PrivateHeader = () => (
  ...
  <div className="content-container">
    ...
    <NavLink className="header__title" to="/post" activeClassName="is-active"><h6>Posts</h6></NavLink>
        <NavLink className="header__title" to="/chat" activeClassName="is-active"><h6>Chats</h6></NavLink>
